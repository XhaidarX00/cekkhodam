...
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton, InlineQueryResultCachedSticker as Sticker, InputTextMessageContent
...
async def inline_query(client: Client, inline_query):
    ...
    for i, sticker in enumerate(stickers):
        results.append(
                Sticker(str(uuid4()), sticker_file_id=sticker,
